"""
Django settings for fancompany project.
...
ALLOWED_HOSTS = ["zeewind.onrender.com", "zeewindenterprises.com", "www.zeewindenterprises.com",]  # Allow all hosts for development
